public class WomenClothing12{
    ...
    public static void main(String[] args) {
        WomenClothing12.kurti("AVAASA", 1299.29);
        WomenClothing12.tops("Levi's", "BLACK", 'M', 2999.99);
        WomenClothing12.cropTop("ZUDIO", 599.78645, "SLEEVELESS");
        WomenClothing12.bottomWear("DNMX", 999.9999, "MOM-FIT", 34);
        WomenClothing12.dress("LOV", 2149.89, "A-LINE", 30096353);
    }
}
